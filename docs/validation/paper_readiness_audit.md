...
- Architecture and development navigation are now split across `docs/architecture/codebase_modularity_review.md`, `docs/architecture/artifact_policy.md`, and `docs/development.md`.
